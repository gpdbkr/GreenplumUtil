...
scp gpfailover.service smdw:/usr/lib/systemd/system/
...
ssh root@smdw 'systemctl daemon-reload'
ssh root@smdw 'systemctl start gpfailover'
ssh root@smdw 'systemctl is-active gpfailover'
ssh root@smdw 'systemctl status gpfailover'
ssh root@smdw 'systemctl enable gpfailover'
