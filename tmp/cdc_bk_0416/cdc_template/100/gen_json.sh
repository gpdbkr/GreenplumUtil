...
select '{ "id":   '|| i ||
	   ...
	   ', "ts": "'||to_char(clock_timestamp(),'yyyy-mm-ddThh24:mi:ss.us')|| '"' ||
	   ', "cud_fg": "U" }'
from   generate_series(20001,400000) i
;

select '{ "id":   '|| i ||
	   ', "ts": "'||to_char(clock_timestamp(),'yyyy-mm-ddThh24:mi:ss.us')|| '"' ||
	   ', "cud_fg": "D" }'
from   generate_series(60001,800000) i
;
...
select '{ "id":   '|| i ||
	   ...
	   ', "ts": "'||to_char(clock_timestamp(),'yyyy-mm-ddThh24:mi:ss.us')|| '"' ||
	   ', "cud_fg": "I" }'
from   generate_series(20001,20000000) i
;
...
select '{ "id":   '|| i ||
	   ...
	   ', "ts": "'||to_char(clock_timestamp(),'yyyy-mm-ddThh24:mi:ss.us')|| '"' ||
	   ', "cud_fg": "U" }'
from   generate_series(22001,240000) i
;

select '{ "id":   '|| i ||
	   ', "ts": "'||to_char(clock_timestamp(),'yyyy-mm-ddThh24:mi:ss.us')|| '"' ||
	   ', "cud_fg": "D" }'
from   generate_series(260001,280000) i
;
